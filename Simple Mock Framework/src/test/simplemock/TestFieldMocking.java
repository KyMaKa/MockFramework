...
import main.simplemock.MockException;
...
public class TestFieldMocking {
    ...
    public void test_mocking_private_field() {
        ...
        Assert.assertEquals("overridden", SimpleMock.getFieldValue(instance,
            "field", String.class));
    }
    ...
    public void test_mocking_default_field() {
        ...
        Assert.assertEquals("overridden", SimpleMock.getFieldValue(instance,
            "fieldDefaultVisibility", String.class));
    }
    ...
    public void test_mocking_protected_field() {
        ...
        Assert.assertEquals("overridden", SimpleMock.getFieldValue(instance,
            "fieldProtectedVisibility", String.class));
    }
    ...
    public void test_mocking_public_field() {
        ...
        Assert.assertEquals("overridden", SimpleMock.getFieldValue(instance,
            "fieldPublicVisibility", String.class));
    }

    @Test
    public void test_mocking_static_field() {
        SimpleMock.mockStaticField(SomeClass.class, "staticField", "overridden");
        Assert.assertEquals("overridden", SimpleMock.getStaticFieldValue(SomeClass.class,
            "staticField", String.class));
